...
insert into Produto (id, nome, preco, descricao) values (2, 'Câmera GoPro Hero 7', 1400.0, 'Desempenho 2x melhor.');
insert into Produto (id, nome, preco, descricao) values (3, 'Câmera GoPro Hero 6', 1000.0, 'Muito Boa.');
